...
+
        <nav className="mt-auto pt-10" aria-label="Primary navigation"><div className="mx-auto flex max-w-md items-center justify-around rounded-2xl border border-[#E5E7EB] bg-white/80 p-2 shadow-lg shadow-gray-900/5 backdrop-blur-[12px]"><Link href="/" className="flex flex-col items-center gap-1 rounded-xl bg-blue-50 px-5 py-2 text-xs font-semibold text-[#0061E0]" aria-current="page"><span className="text-sm">H</span>Home</Link><Link href="/tasks" className="flex flex-col items-center gap-1 rounded-xl px-5 py-2 text-xs font-medium text-gray-500 transition hover:bg-[#F3F4F6] hover:text-gray-900"><span className="text-sm">N</span>Notes</Link><Link href="/tasks" className="flex flex-col items-center gap-1 rounded-xl px-5 py-2 text-xs font-medium text-gray-500 transition hover:bg-[#F3F4F6] hover:text-gray-900"><span className="text-sm">T</span>Tasks</Link><Link href="/Login" className="flex flex-col items-center gap-1 rounded-xl px-5 py-2 text-xs font-medium text-gray-500 transition hover:bg-[#F3F4F6] hover:text-gray-900"><span className="text-sm">A</span>Profile</Link></div></nav>
      </div>
    </main>
  );
}
